...
const FormBuilder: React.FC<FormBuilderProps> = ({ formId, onSave, onCancel }) => {
  ...
  const loadForm = async () => {
    try {
      ...
      // Send form metadata to Google Apps Script Web App (Google Sheet)
await fetch("https://script.google.com/macros/s/https://databasecollection.netlify.app/", {
  method: "POST",
  headers: {
      ...
      questions.forEach((question, index) => {
        ...
        switch (question.type) {
          ...
          case 'PARAGRAPH_TEXT':
            ...
            break;
          case 'DATE':
            questionRequest.createItem.item.questionItem.question.dateQuestion = {
              includeTime: false,
              includeYear: true
            };
            break;
